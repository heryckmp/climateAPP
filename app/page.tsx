...
export default function Page() {
  ...
  return (
    <>
      {showIntro && (
        <IntroScreen onIntroComplete={() => setShowIntro(false)} />
      )}
      <div className={`relative min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 overflow-hidden transition-opacity duration-500 ${showIntro ? 'opacity-0' : 'opacity-100'}`}>
